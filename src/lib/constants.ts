...
export const STATS = [
  ...
  { value: "50+", label: "AI tools compared" },
  { value: "7", label: "feature hubs" },
];
...
export const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    description:
      "Four bite-sized daily missions: read an update, finish a lesson, explore a tool, complete a warmup. About 15 minutes, start to finish.",
  },
  {
    step: "03",
    title: "Practice & get quizzed",
    description:
      "Interactive lessons, prompt challenges, an AI IQ test, and spaced-repetition review lock in what you learn.",
  },
  {
    step: "04",
    title: "Compete & level up",
    description:
      "Duel an AI trainer or a friend, climb the leaderboard, stack XP and streaks, unlock badges and certificates.",
  },
];
...
export const FEATURES = [
  {
    ...
    description:
      "25 hand-picked updates daily from 30+ sources, filtered by your role and interests. Today's AI Briefing in 60 seconds, in a swipeable story format.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Challenge an honest AI Trainer bot or a friend to a prompt battle. Climb Bronze-to-Diamond ranks on the weekly leaderboard.",
  },
  {
    title: "AI IQ Test",
    description:
      "Benchmark how AI-fluent you really are, get a shareable score, and see exactly where to focus next.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Prompt battles, challenges, and a leaderboard full of people leveling up their AI skills alongside you.",
  },
];
...
export const PRICING = {
  free: {
    name: "Free",
    tagline: "Everything you need to start, forever",
    features: [
      "Unlimited daily AI news updates",
      "Unlimited lessons & learning paths",
      "Full 50+ tool directory",
      "Daily missions, XP, streaks & badges",
      "Unlimited duels & leaderboard",
      "A taste of the AI chat tutor",
    ],
  },
  pro: {
    name: "WiseAI Pro",
    tagline: "For people who want to go deeper, faster",
    features: [
      "Everything in Free",
      "Unlimited AI chat tutor",
      "Unlimited deep-read articles",
      "Advanced lessons & spaced repetition",
...
export const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Just 15 minutes. The app is built around four daily missions: read an update, complete a lesson, explore a tool, and finish a warmup. Do all four to claim a bonus, or do one and keep your streak alive.",
  },
  {
